...
function SampleNextArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block", background: "rgba(255, 255, 255, 0.7)", borderRadius: "50%", right: "10px" }}
      onClick={onClick}
    />
  );
}
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className={className}
      style={{ ...style, display: "block", background: "rgba(255, 255, 255, 0.7)", borderRadius: "50%", left: "10px", zIndex: 1 }}
      onClick={onClick}
    />
  );
}
